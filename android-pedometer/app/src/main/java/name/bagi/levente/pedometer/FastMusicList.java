 ...
 */
public class FastMusicList extends Activity{
    String Path ;
    ListView songs_list ;
    String[] items;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        AddSongButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(FastMusicList.this , ShowTotalMusic.class) ;
                String speed = "fast" ;
        ...
        for(int i = 0  ; i < res_size; i++ , res.moveToNext()){
            ...
            Songs = findSongs(Environment.getExternalStorageDirectory() , res.getString(1));
