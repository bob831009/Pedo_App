...
public class Pedometer extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button category_button = (Button)findViewById(R.id.button) ;
        category_button.setOnClickListener ( new View.OnClickListener(){
            @Override
            public void onClick(View v){
            Intent i = new Intent(Pedometer.this , Category.class) ;
            startActivity(i);
            }
        });

        Button StartSongButton = (Button) findViewById(R.id.StartButton) ;
        ...
        Button StopSongButton = (Button) findViewById(R.id.StopButton) ;
    ...
    protected void onResume() {
        ...
        mTimerValueView    = (TextView) findViewById(R.id.timer) ;
        ...
        @Override public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case PACE_MSG:
                    ...
                    Long spend_time = System.currentTimeMillis() - past_time ;
                    if((spend_time /1000)%60 >= 30){
                        Log.e("a" , "spend time is over 1 min!") ;
                        if ((int)mPaceValue > 200){
                            change_music();
                        }else if ((int)mPaceValue < 200 && (int)mPaceValue > 50){
                            change_music();
                        }else if ((int)mPaceValue < 50 && (int)mPaceValue > 0){
                            change_music();
                        }
